...
@section('content')
	...
	<div id="content" class="span10">
		<ul class="breadcrumb">
			...
			<li>
				<i class="icon-edit"></i>
				<a href="#">Mostrar Noticia</a>
			</li>
		</ul>

		
			<a class="btn btn-primary" href="news/create">Agregar Noticia</a></button>
			<p></p>
		...
		<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span>Noticias</h2>
						<div class="box-icon">
						  ...
						  <tbody>
						  	...
						  	@foreach($newspaper as $news)
								<tr>
									...
									<td>{!!$news->name!!}</td>
									<td class="center">
										<?php $image_name = "images/news/news_".$news->id.".".$news->extension ?>
										{!! Html::image($image_name,'a picture', array('width' => '200')) !!}
									</td>
									<td class="center">{!! $news->Created_by->name !!}</td>
									<td class="center">
										<?php
									...
									<td class="center">{!! $news->created_at !!}</td>
										<?php 
											if (is_null($news->deleted_at)) {
												$route_edit = "/news/".$news->id."/edit";
												$route_destroy = "/news/".$news->id."/inactive";

												$status = "active";
											}else{

												$route_untrashed = "/news/".$news->id."/untrashed";
												$status = "inactive";
											}
										?>
									<td class="center">
